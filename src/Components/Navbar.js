...
const Navbar = () => {
    ...
    return (
        <MaterialNavbar className={`mx-auto px-4 py-2 lg:px-8 lg:py-4  ${isDarkMode ? 'bg-stone-200' : 'bg-stone-800'}`}>
            <div className={`container mx-auto flex items-center justify-between ${isDarkMode ? 'text-stone-800' : 'text-stone-200'}`}>
                ...
                <div className="flex items-center gap-x-1">
                    <Button variant="text" size="sm" className={`hidden lg:inline-block ${isDarkMode ? 'bg-gray-800' : 'bg-stone-100'}`}>
                        <span className={` ${isDarkMode ? 'text-stone-200' : 'text-stone-800'}`}>Log in</span>
            ...
            <MobileNav open={openNav}>
                <div className={`container mx-auto ${isDarkMode ? 'bg-gray-200' : 'bg-stone-800'}`}>{navList}</div>
            </MobileNav>
        </MaterialNavbar>
    );
};
