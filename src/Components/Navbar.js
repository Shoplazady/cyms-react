...
const Navbar = () => {
    ...
    const navList = (
        <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 max-w-screen-xl mx-auto text-stone-200">
    ...
    return (
        <MaterialNavbar className="mx-auto px-4 py-2 lg:px-8 lg:py-4 bg-stone-800">
            <div className="container mx-auto flex items-center justify-between text-stone-200">
                ...
                <div className="flex items-center gap-x-1">
                    <Button variant="text" size="sm" className="hidden lg:inline-block bg-stone-100">
