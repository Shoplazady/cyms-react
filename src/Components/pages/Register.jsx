...
const Register = () => {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-stone-800 dark:bg-gray-100">
            {/* Register form*/}
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:mt-16 lg:py-0">
                <div class="w-full max-w-md bg-stone-900 rounded-lg shadow-lg dark:bg-white border-gray-200 sm:w-full">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            {/* Username Input */}
                            <div class="relative">
                                <label for="username" class="block mb-2 text-sm font-medium text-white dark:text-gray-900">Your username</label>
                                <div class="flex">
