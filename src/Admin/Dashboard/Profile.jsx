                ...
                <div className="flex flex-col items-center p-6 w-96 bg-gray-800 dark:bg-white rounded-lg">
                    <div className="flex flex-col justify-center items-center pt-16">
                        ...
                        {userData.picture_path !== "" ? (
                            <img className="rounded-full w-40 h-40" src={userData.picture_path} alt="profileuser" />
                        ) : (
                            <img className="rounded-full w-40 h-40" src={require('../../Components/images/no_image.png')} alt="profileuser" />
                        )}
                        <form>
                            <input
                                type="file"
